...
use syster::semantic::adapters::kerml::inlay_hints::extract_inlay_hints;
use syster::semantic::symbol_table::{Symbol, SymbolTable};
use syster::semantic::types::{InlayHint, InlayHintKind};
    ...
    let file = KerMLFile {
        ...
        elements: vec![Element::Package(Package {
            ...
            elements: vec![
                ...
                Element::Import(syster::syntax::kerml::ast::Import {
    ...
    let file = KerMLFile {
        ...
        elements: vec![Element::Feature(Feature {
            ...
            body: vec![FeatureMember::Subsetting(
                syster::syntax::kerml::ast::Subsetting {
