...
fn test_sysml_extract_inlay_hints_empty_file() {
    use super::sysml::inlay_hints::extract_inlay_hints as extract_sysml_inlay_hints;
...
fn test_kerml_extract_inlay_hints_empty_file() {
    use super::kerml::inlay_hints::extract_inlay_hints as extract_kerml_inlay_hints;
